...
import fun.qu_an.minecraft.asyncparticles.client.mixin.compat.cloth_config.AccessorBaseListEntry;
...
public class StringListListEntryFixRestart extends StringListListEntry {
	...
	public StringListListEntryFixRestart(StringListListEntry toFix) {
		super(toFix.getFieldName(),
			...
			((AccessorBaseListEntry) toFix).asyncparticles$getDefaultValue(),
			((AccessorBaseListEntry) toFix).asyncparticles$getResetWidget().getMessage(),
			false,
