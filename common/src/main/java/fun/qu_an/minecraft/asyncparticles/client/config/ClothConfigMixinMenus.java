...
public class ClothConfigMixinMenus {
	static void buildCategory(@Nullable MixinConfigBundle bundle,
		...
		MixinConfigObj displayConfig = bundle.displayConfig();
		MixinConfigObj defaultConfig = bundle.defaultConfig();
		MixinConfigObj originalConfig = bundle.originalConfig();
...
//			.requireRestart()
	...
	record MixinConfigBundle(
		MixinConfigObj displayConfig,
		MixinConfigObj defaultConfig,
		@Nullable MixinConfigObj originalConfig) {
