...
public class TrackedParticleCountsMap extends Object2IntOpenHashMap<ParticleLimit> {
	...
	@Override
	public int addTo(ParticleLimit key, int value) {
		spinLock.lock();
		try {
	...
	public int put(ParticleLimit k, int v) {
		spinLock.lock();
		try {
