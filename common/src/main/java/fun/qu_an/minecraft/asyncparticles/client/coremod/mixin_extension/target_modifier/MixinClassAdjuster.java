...
public interface MixinClassAdjuster {
	 ...
	 * @param modifiedClassNode provide a remapped class node
	 * @apiNote DO NOT modify targets here
	 * @return a new ClassNode or the modifiedClassNode
	 */
	@ApiStatus.Experimental
	default ClassNode adjustSpecial(String modifiedTargetClassName, Supplier<ClassNode> modifiedClassNode) {
		return null;
	}
}
