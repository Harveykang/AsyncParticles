...
public class SubtleEffectsCompat {
	public static boolean shouldRenderParticle(Particle particle, Camera camera, ParticleRenderType renderType) {
		...
		if (!ModListHelper.VS_LOADED &&
			...
			!Util.isChunkLoaded(Minecraft.getInstance().level, particle.x, particle.z)) {
			return false;
		}
